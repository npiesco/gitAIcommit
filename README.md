...
OPTIONS:
    -m, --model <MODEL>             AI model to use [default: gemma4:latest]
...
export GIT_AI_COMMIT_MODEL=gemma4:latest
...
- `gemma4:latest` (default) - Best balance of performance and quality
